...
`192.168.4.94:5672`, resulting in connection refused errors.
...
```
Attempting to connect to: [192.168.4.94:5672]
```
...
2. Verify environment variable format: `RABBITMQ_HOST=192.168.4.94` (no extra spaces)
3. Rebuild the project: `mvn clean compile`
4. Restart the application

### Connection refused despite correct host?

1. Verify RabbitMQ is running on `192.168.4.94:5672`:
   ```bash
   nc -zv 192.168.4.94 5672
   ```
...
```bash
# If RabbitMQ is running locally on 192.168.4.94
