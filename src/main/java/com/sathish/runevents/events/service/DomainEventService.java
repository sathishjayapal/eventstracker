...
public class DomainEventService {
    ...
    @Autowired
    public DomainEventService(DomainEventRepo domainEventRepo, DomainRepo domainRepo, DomainEventMapper domainEventMapper) {
    ...
    public DomainEventDTO createDomainEvent(DomainEventDTO domainEventDTO) {
        ...
        if (domain.isPresent()) {
            ...
            domainEvent = domainEventRepo.save(domainEvent);
