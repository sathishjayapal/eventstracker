...
public interface DomainEventMapper {
    ...
    DomainEventDTO updateDomainEventDTO(DomainEvent domainEvent, @MappingTarget DomainEventDTO domainEventDTO);

    @AfterMapping
    default void afterUpdateDomainEventDTO(DomainEvent domainEvent, @MappingTarget DomainEventDTO domainEventDTO) {
        domainEventDTO.setDomain(
                domainEvent.getDomain() == null ? null : domainEvent.getDomain().getId());
    }
    ...
    @AfterMapping
    default void afterUpdateDomainEvent(
            DomainEventDTO domainEventDTO,
            @MappingTarget DomainEvent domainEvent,
            @Context DomainRepository domainRepository) {
